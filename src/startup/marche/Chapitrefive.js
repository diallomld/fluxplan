          ...
          <Paper className={classes.root}>
            <TableContainer className={classes.container}>
              <Table stickyHeader aria-label="sticky table">
                <caption style={{color: 'black', fontSize:30}}>Notre avantage concurrentiel</caption>
                <TableHead>
                  <TableRow>
                    <StyledTableCell style={{minWidth:300}}>Avantage </StyledTableCell>
