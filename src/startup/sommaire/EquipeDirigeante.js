...
const EquipeDirigeantesommaire = () => {
  const editObject = {
    nom: "",
    poste: "",
    capital: "",
          ...
          <Paper className={classes.root}>
            <TableContainer className={classes.container}>
              <Table stickyHeader aria-label="sticky table">
                <caption style={{color: 'black', fontSize:30}}>L’équipe dirigeante</caption>
                <TableHead>
                  <TableRow>
                    <StyledTableCell style={{minWidth:200, maxWidth:300}}>Nom et prénoms</StyledTableCell>
                    <StyledTableCell style={{minWidth:150, maxWidth:300}}>Poste</StyledTableCell>
                    <StyledTableCell style={{minWidth:100, maxWidth:300}}>% Capital</StyledTableCell>
                    <StyledTableCell style={{minWidth:200, maxWidth:300}}>Diplômes</StyledTableCell>
                    <StyledTableCell style={{minWidth:200, maxWidth:300}}>Expériences</StyledTableCell>
...
export default EquipeDirigeantesommaire
